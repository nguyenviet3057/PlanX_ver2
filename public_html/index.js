...
$("#information").scroll(function(){
    ...
    if ($("#contact_p").offset().top > (-parseInt($("#contact_p").css("height"))+0.6*t) && document.getElementById("h_r").style.borderRight == "none" && document.getElementById("i_r").style.borderRight == "none"){
        $("#c_r").css("border-right","solid 5px black");
    }else{
        $("#c_r").css("border-right","none");
    };
    if ($("#support_p").offset().top > (-t) && document.getElementById("h_r").style.borderRight == "none" && document.getElementById("i_r").style.borderRight == "none" && document.getElementById("c_r").style.borderRight == "none"){
        $("#s_r").css("border-right","solid 5px black");
    }else{
        $("#s_r").css("border-right","none");
    };
});
...
$("#s_r").click(function(){
    document.getElementById("support_p").scrollIntoView({behavior:"smooth"});
});
